...
type MiddlewareMapValue<T extends MiddlewareComposeBase> = OmitUse<T> & MiddlewareBase
type KeyOptMapping<T extends MiddlewareComposeBase> = Partial<
  Record<T['use'], MiddlewareMapValue<T>>
>
