 ...
 * header {key} {value}
 *
 * Match the request header with the given key and value.
 *
 * @examples ["header Content-Type application/json"]
 */
type RuleOnHeader = `header ${HTTPHeader} ${string}`;
/**
 * header {key}
 *
 ...
 * query {key} {value}
 *
 * Match the request query with the given key and value.
 *
 * @examples ["query key value"]
 */
type RuleOnQuery = `query ${HTTPQuery} ${string}`;
/**
 * query {key}
 *
 ...
 * cookie {key} {value}
 *
 * Match the request cookie with the given key and value.
 *
 * @examples ["cookie key value"]
 */
type RuleOnCookie = `cookie ${HTTPCookie} ${string}`;
/**
 * cookie {key}
 *
 ...
 * form {key} {value}
 *
 * Match the request form with the given key and value.
 *
 * @examples ["form key value"]
 */
type RuleOnForm = `form ${string} ${string}`;
/**
 * form {key}
 *
 ...
 * post_form {key} {value}
 *
 * Match the request post form with the given key and value.
 *
 * @examples ["post_form key value"]
 */
type RuleOnPostForm = `post_form ${string} ${string}`;
/**
 * post_form {key}
 *
 ...
 * path {glob_pattern}
 *
 * Match the request path with the given glob pattern.
 *
 * @examples ["path /api/*"]
 */
type RuleOnPath = `path ${Glob}`;
/**
 * remote {ip|cidr}
 *
 ...
 * route {alias}
 *
 * Match the request route with the given alias.
 *
 * @examples ["route immich"]
 */
type RuleOnRoute = `route ${string}`;
/**
