...
export default function AppItemContextMenuContent({
  ...
  return (
    <ContextMenuContent>
      <ContextMenuItem
        onClick={() => store.editingApp.set({ categoryIndex: categoryIndex, itemIndex: itemIndex })}
      >
      ...
      <Link to="/routes" hash={routeKey} preload={false} onClick={() => setSelectedRoute(routeKey)}>
        <ContextMenuItem>
