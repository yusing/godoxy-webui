...
export default function RouteEditForm({
  ...
  const sections: SectionItem<FormSectionId>[] = useMemo(
    () =>
      [
        { id: 'general', label: 'General', Icon: Route, show: true },
        {
          id: 'fileserver',
          label: 'File Server',
          Icon: Folders,
        ...
        { id: 'http', label: 'HTTP Config', Icon: Settings, show: showHTTPConfig },
        { id: 'ssl', label: 'SSL Config', Icon: Lock, show: showSSLConfig },
        { id: 'mtls', label: 'Inbound mTLS', Icon: Lock, show: showInboundMTLS },
        { id: 'healthcheck', label: 'Health Check', Icon: Heart, show: true },
        { id: 'proxmox', label: 'Proxmox', Icon: Server, show: showProxmox },
        {
          id: 'idlewatcher',
          label: 'Idlewatcher',
          Icon: Timer,
